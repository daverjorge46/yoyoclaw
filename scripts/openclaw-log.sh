...
show_usage() {
    cat << EOF
openclaw-log - OpenClaw Logging Utility

USAGE:
    openclaw-log [OPTIONS]
...
EXAMPLES:
    openclaw-log                   Show last 50 lines from past 5 minutes (default)
    openclaw-log -f                Stream logs continuously
    openclaw-log -n 100            Show last 100 lines
    openclaw-log -e                Show only recent errors
    openclaw-log -l 30m -n 200     Show last 200 lines from past 30 minutes
    openclaw-log -c ServerManager  Show recent ServerManager logs
    openclaw-log -s "fail"         Search for "fail" in recent logs
    openclaw-log --server -e       Show recent server errors
    openclaw-log -f -d             Stream debug logs continuously
