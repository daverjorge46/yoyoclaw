...
read_when:
  - You are building a YoyoClaw plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (yoyoclaw.plugin.json)

Every plugin **must** ship a `yoyoclaw.plugin.json` file in the **plugin root**.
YoyoClaw uses this manifest to validate configuration **without executing plugin
