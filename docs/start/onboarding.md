---
summary: "First-run onboarding flow for YoyoClaw (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give YoyoClaw">
...
<Step title="CLI">
  ...
  The app can install the global `yoyoclaw` CLI via npm/pnpm so terminal
