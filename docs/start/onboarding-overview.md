---
summary: "Overview of YoyoClaw onboarding options and flows"
read_when:
...
YoyoClaw supports multiple onboarding paths depending on where the Gateway runs
...
- [`yoyoclaw onboard` command](/cli/onboard)

## macOS app onboarding

Use the YoyoClaw app when you want a fully guided setup on macOS. Docs:
