...
yoyoclaw system heartbeat last
yoyoclaw logs --follow
yoyoclaw config get agents.defaults.heartbeat
yoyoclaw channels status --probe
```
...
```bash
yoyoclaw config get agents.defaults.heartbeat.activeHours
yoyoclaw config get agents.defaults.heartbeat.activeHours.timezone
yoyoclaw config get agents.defaults.userTimezone || echo "agents.defaults.userTimezone not set"
yoyoclaw cron list
yoyoclaw logs --follow
```
