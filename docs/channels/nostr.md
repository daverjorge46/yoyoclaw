...
read_when:
  - You want YoyoClaw to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables YoyoClaw to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`yoyoclaw onboard`) and `yoyoclaw channels add` list optional channel plugins.
...
```bash
yoyoclaw plugins install @yoyoclaw/nostr
```

Use a local checkout (dev workflows):

```bash
yoyoclaw plugins install --link <path-to-yoyoclaw>/extensions/nostr
```
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "yoyoclaw",
        "displayName": "YoyoClaw",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "yoyoclaw@example.com",
        "lud16": "yoyoclaw@example.com"
      }
    }
  }
}
