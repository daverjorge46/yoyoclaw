...
- Install via CLI: `yoyoclaw plugins install @yoyoclaw/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `yoyoclaw plugins install ./extensions/zalo`
   - From npm (if published): `yoyoclaw plugins install @yoyoclaw/zalo`
...
- Approve via:
  - `yoyoclaw pairing list zalo`
  - `yoyoclaw pairing approve zalo <CODE>`
...
- Example: `yoyoclaw message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `yoyoclaw channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `yoyoclaw logs --follow`
