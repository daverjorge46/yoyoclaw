...
Note: run `docker compose ...` from the repo root. Include extra `-f` files
only if they were generated by `docker-setup.sh`:

```bash
docker compose -f docker-compose.yml <command>
docker compose -f docker-compose.yml -f docker-compose.extra.yml <command>
docker compose -f docker-compose.yml -f docker-compose.cli-only.yml <command>
docker compose -f docker-compose.yml -f docker-compose.extra.yml -f docker-compose.cli-only.yml <command>
```
