...
Veja [Environment vars](/help/environment) para a precedência e todos os detalhes.
...
Em seguida, abra um novo terminal (ou `rehash` no zsh / `hash -r` no bash). </Accordion>
