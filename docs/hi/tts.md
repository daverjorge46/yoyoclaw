...
11. क्योंकि Edge TTS एक सार्वजनिक वेब सेवा है जिसके पास प्रकाशित SLA या कोटा नहीं है, इसे best-effort के रूप में मानें। 15. यदि आपको गारंटीड लिमिट्स और सपोर्ट चाहिए, तो OpenAI या ElevenLabs का उपयोग करें।
12. Microsoft की Speech REST API प्रति अनुरोध 10‑मिनट की ऑडियो सीमा का दस्तावेज़ करती है; Edge TTS सीमाएँ प्रकाशित नहीं करता, इसलिए समान या कम सीमाएँ मानें। 17. citeturn0search3
...
19. यदि कई प्रदाता कॉन्फ़िगर किए गए हों, तो चयनित प्रदाता पहले उपयोग होता है और अन्य फ़ॉलबैक विकल्प होते हैं।
20. ऑटो‑समरी कॉन्फ़िगर किए गए `summaryModel` (या `agents.defaults.model.primary`) का उपयोग करता है, इसलिए यदि आप समरी सक्षम करते हैं तो उस प्रदाता को भी प्रमाणित होना चाहिए।
