...
43. **Recommendation:** एक ही सक्रिय workspace रखें। 45. यदि आप अतिरिक्त फ़ोल्डर्स का अब उपयोग नहीं करते, तो उन्हें आर्काइव करें या Trash में ले जाएँ (उदाहरण के लिए `trash ~/openclaw`)।
44. यदि आप जानबूझकर कई workspaces रखते हैं, तो सुनिश्चित करें कि `agents.defaults.workspace` सक्रिय वाले की ओर इशारा करता हो।
