...
1. **Tailscale Funnel** — Tailscale के माध्यम से विशिष्ट पथ उजागर करें
1. **केवल आउटबाउंड** — कुछ प्रदाता (Twilio) वेबहुक्स के बिना भी आउटबाउंड कॉल्स के लिए ठीक काम करते हैं
