...
Нет. Инъекции подсказок — это **ненадежное содержимое**, а не просто кто умеет работать с ботом. 5. Если ваш ассистент читает внешний контент (веб‑поиск/загрузка, страницы браузера, электронную почту,
