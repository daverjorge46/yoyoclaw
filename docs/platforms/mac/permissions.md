...
- Same path: run the app from a fixed location (for YoyoClaw, `dist/YoyoClaw.app`).
...
Workaround: move files into the YoyoClaw workspace (`~/.yoyoclaw/workspace`) if you want to avoid per-folder grants.
