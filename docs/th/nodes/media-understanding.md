...
สำหรับรายการCLI **ให้ตั้งค่า `capabilities` อย่างชัดเจน**เพื่อหลีกเลี่ยงการจับคู่ที่ไม่คาดคิด หากคุณละเว้น `capabilities` รายการจะมีสิทธิ์สำหรับรายการที่มันปรากฏอยู่ 38. หากคุณไม่ใส่ `capabilities` รายการจะมีสิทธิ์ตามรายการที่มันปรากฏอยู่
