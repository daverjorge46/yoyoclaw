...
นอกจากนี้ยังเตือนเมื่อใช้โมเดลขนาดเล็ก(`<=300B`)โดยไม่ใช้ sandboxing และเปิดใช้งานเครื่องมือเว็บ/เบราว์เซอร์อยู่ 5. นอกจากนี้ยังจะแจ้งเตือนเมื่อใช้โมเดลขนาดเล็ก (`<=300B`) โดยไม่เปิด sandbox และเปิดใช้เครื่องมือเว็บ/เบราว์เซอร์
