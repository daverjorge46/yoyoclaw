...
เมื่อรัน OpenClaw บนอินสแตนซ์ EC2 ที่มีการแนบบทบาท IAM, AWS SDK จะใช้บริการเมทาดาทาของอินสแตนซ์ (IMDS) เพื่อยืนยันตัวตนโดยอัตโนมัติ อย่างไรก็ตาม การตรวจจับข้อมูลประจำตัวของ OpenClaw ในปัจจุบันตรวจสอบเฉพาะตัวแปรสภาพแวดล้อม ไม่ได้ตรวจสอบข้อมูลประจำตัวจาก IMDS 41. อย่างไรก็ตาม การตรวจจับข้อมูลรับรองของ OpenClaw ในปัจจุบันตรวจสอบเฉพาะตัวแปรสภาพแวดล้อม
