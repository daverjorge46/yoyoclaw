...
ในโหมด `"non-main"` คีย์กลุ่ม/แชนเนลจะ _ไม่_ เป็น main ในโหมด `"non-main"` คีย์ของกลุ่ม/ช่องทางจะ *ไม่*ใช่ main ใช้คีย์เซสชัน main (แสดงโดย `sandbox explain`) หรือสลับโหมดเป็น `"off"`
