...
OpenClaw.appใช้อุโมงค์SSHเพื่อเชื่อมต่อกับเกตเวย์ระยะไกล คู่มือนี้จะแสดงวิธีการตั้งค่า คู่มือนี้แสดงวิธีตั้งค่า
...
OpenClaw.app เชื่อมต่อไปที่ `ws://127.0.0.1:18789` บนเครื่องไคลเอนต์ของคุณ OpenClaw.appเชื่อมต่อไปยัง`ws://127.0.0.1:18789`บนเครื่องไคลเอนต์ของคุณ จากนั้นอุโมงค์SSHจะส่งต่อการเชื่อมต่อนั้นไปยังพอร์ต18789บนเครื่องระยะไกลที่Gatewayกำลังทำงานอยู่
