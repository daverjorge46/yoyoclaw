---
summary: "Use NVIDIA's OpenAI-compatible API in YoyoClaw"
read_when:
  - You want to use NVIDIA models in YoyoClaw
...
yoyoclaw onboard --auth-choice skip
yoyoclaw models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
