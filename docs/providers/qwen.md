---
summary: "Use Qwen OAuth (free tier) in YoyoClaw"
read_when:
  - You want to use Qwen with YoyoClaw
...
If you already logged in with the Qwen Code CLI, YoyoClaw will sync credentials
