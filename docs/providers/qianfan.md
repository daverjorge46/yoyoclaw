---
summary: "Use Qianfan's unified API to access many models in YoyoClaw"
read_when:
...
3. YoyoClaw installed on your system
...
4. Copy the API key for use with YoyoClaw

## CLI setup

```bash
yoyoclaw onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [YoyoClaw Configuration](/gateway/configuration)
