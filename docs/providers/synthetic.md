---
summary: "Use Synthetic's Anthropic-compatible API in YoyoClaw"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. YoyoClaw registers it as the
...
Note: YoyoClaw's Anthropic client appends `/v1` to the base URL, so use
