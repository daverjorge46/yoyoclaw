...
You can point YoyoClaw at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or YoyoClaw
...
- [Anthropic provider](/providers/anthropic) - Native YoyoClaw integration with Claude setup-token or API keys
