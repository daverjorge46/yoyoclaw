---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with YoyoClaw"
read_when:
  - You want Xiaomi MiMo models in YoyoClaw
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). YoyoClaw uses
