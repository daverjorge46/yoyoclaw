...
YoyoClaw has two separate “streaming” layers:
...
When block streaming is enabled, YoyoClaw can **merge consecutive block chunks**
...
When draft streaming is active, YoyoClaw disables block streaming for that reply to avoid double-streaming.
