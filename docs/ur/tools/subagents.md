...
1. 23. نتیجہ، اسٹیٹس اور اعداد و شمار کے ساتھ ایک خلاصہ پیغام مرکزی ایجنٹ کے سیشن کو بھیجا جاتا ہے
1. 24. مرکزی ایجنٹ آپ کی چیٹ میں قدرتی زبان میں خلاصہ پوسٹ کرتا ہے
