...
- 生成的 Swift 模型：`apps/macos/Sources/YoyoClawProtocol/GatewayModels.swift`
...
- https://raw.githubusercontent.com/daverjorge46/yoyoclaw/main/dist/protocol.schema.json
