...
通过一键模板在 Railway 上部署 YoyoClaw，并在浏览器中完成设置。
...
- `https://<your-railway-domain>/yoyoclaw` — 控制面板 UI
...
- `OPENCLAW_STATE_DIR=/data/.yoyoclaw`（推荐）
...
这会导出你的 YoyoClaw 状态和工作区，方便你迁移到其他主机而不丢失配置或记忆。
