...
- [向导](/zh-CN/start/wizard)
- [安装配置](/zh-CN/start/setup)
...
- [Mattermost](/zh-CN/channels/mattermost)（插件）
...
- [Gmail Pub/Sub](/zh-CN/automation/gmail-pubsub)
...
- [定时任务 vs 心跳](/zh-CN/automation/cron-vs-heartbeat)
...
- [轮询](/zh-CN/automation/poll)

## 节点、媒体、语音

- [节点概览](/zh-CN/nodes)
- [摄像头](/zh-CN/nodes/camera)
- [图片](/zh-CN/nodes/images)
...
- [macOS 开发环境配置](/zh-CN/platforms/mac/dev-setup)
- [macOS 菜单栏](/zh-CN/platforms/mac/menu-bar)
- [macOS 语音唤醒](/zh-CN/platforms/mac/voicewake)
- [macOS 语音悬浮窗](/zh-CN/platforms/mac/voice-overlay)
...
- [macOS 发布](/zh-CN/platforms/mac/release)
...
- [新手引导配置协议](/zh-CN/experiments/onboarding-config-protocol)
- [定时任务加固笔记](/zh-CN/experiments/plans/cron-add-hardening)
- [群组策略加固笔记](/zh-CN/experiments/plans/group-policy-hardening)
- [研究：记忆](/zh-CN/experiments/research/memory)
- [模型配置探索](/zh-CN/experiments/proposals/model-config)
...
- [发布检查清单](/zh-CN/reference/RELEASING)
