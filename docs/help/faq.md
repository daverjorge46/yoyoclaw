---
summary: "Frequently asked questions about YoyoClaw setup, configuration, and usage"
title: "FAQ"
---
...
- [Quick start and first-run setup]
  ...
  - [What's the recommended way to install and set up YoyoClaw?](#whats-the-recommended-way-to-install-and-set-up-yoyoclaw)
  ...
  - [Windows install says git not found or yoyoclaw not recognized](#windows-install-says-git-not-found-or-yoyoclaw-not-recognized)
  - [The docs didn't answer my question - how do I get a better answer?](#the-docs-didnt-answer-my-question-how-do-i-get-a-better-answer)
  - [How do I install YoyoClaw on Linux?](#how-do-i-install-yoyoclaw-on-linux)
  - [How do I install YoyoClaw on a VPS?](#how-do-i-install-yoyoclaw-on-a-vps)
  - [Where are the cloud/VPS install guides?](#where-are-the-cloudvps-install-guides)
  - [Can I ask YoyoClaw to update itself?](#can-i-ask-yoyoclaw-to-update-itself)
  ...
  - [If I buy a Mac mini to run YoyoClaw, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-yoyoclaw-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different YoyoClaw instances?](#can-multiple-people-use-one-whatsapp-number-with-different-yoyoclaw-instances)
  - [Can I run a "fast chat" agent and an "Opus for coding" agent?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  - [Does Homebrew work on Linux?](#does-homebrew-work-on-linux)
  - [What's the difference between the hackable (git) install and npm install?](#whats-the-difference-between-the-hackable-git-install-and-npm-install)
  - [Can I switch between npm and git installs later?](#can-i-switch-between-npm-and-git-installs-later)
  - [Should I run the Gateway on my laptop or a VPS?](#should-i-run-the-gateway-on-my-laptop-or-a-vps)
  - [How important is it to run YoyoClaw on a dedicated machine?](#how-important-is-it-to-run-yoyoclaw-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run YoyoClaw in a VM and what are the requirements](#can-i-run-yoyoclaw-in-a-vm-and-what-are-the-requirements)
- [What is YoyoClaw?](#what-is-yoyoclaw)
  - [What is YoyoClaw, in one paragraph?](#what-is-yoyoclaw-in-one-paragraph)
  - [What's the value proposition?](#whats-the-value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for YoyoClaw](#what-are-the-top-five-everyday-use-cases-for-yoyoclaw)
  - [Can YoyoClaw help with lead gen outreach ads and blogs for a SaaS](#can-yoyoclaw-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can YoyoClaw run tasks on a schedule or continuously in the background?](#can-yoyoclaw-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with YoyoClaw saved locally?](#is-all-data-used-with-yoyoclaw-saved-locally)
  - [Where does YoyoClaw store its data?](#where-does-yoyoclaw-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [What's the recommended backup strategy?](#whats-the-recommended-backup-strategy)
  - [How do I completely uninstall YoyoClaw?](#how-do-i-completely-uninstall-yoyoclaw)
...
- [Config basics](#config-basics)
  ...
  - [Can the YoyoClaw browser run headless?](#can-the-yoyoclaw-browser-run-headless)
...
- [Remote gateways and nodes](#remote-gateways-and-nodes)
  ...
  - [Can two YoyoClaw instances talk to each other (local + VPS)?](#can-two-yoyoclaw-instances-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does YoyoClaw load environment variables?](#how-does-yoyoclaw-load-environment-variables)
...
- [Sessions and multiple chats](#sessions-and-multiple-chats)
  ...
  - [Is there a way to make a team of YoyoClaw instances one CEO and many agents](#is-there-a-way-to-make-a-team-of-yoyoclaw-instances-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset YoyoClaw but keep it installed?](#how-do-i-completely-reset-yoyoclaw-but-keep-it-installed)
  ...
  - [Why doesn't YoyoClaw reply in a group?](#why-doesnt-yoyoclaw-reply-in-a-group)
...
- [Models: defaults, selection, aliases, switching](#models-defaults-selection-aliases-switching)
  ...
  - [What do YoyoClaw, Flawd, and Krill use for models?](#what-do-yoyoclaw-flawd-and-krill-use-for-models)
...
- [Gateway: ports, "already running", and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [Why does `yoyoclaw gateway status` say `Runtime: running` but `RPC probe: failed`?](#why-does-yoyoclaw-gateway-status-say-runtime-running-but-rpc-probe-failed)
  - [Why does `yoyoclaw gateway status` show `Config (cli)` and `Config (service)` different?](#why-does-yoyoclaw-gateway-status-show-config-cli-and-config-service-different)
  - [What does "another gateway instance is already listening" mean?](#what-does-another-gateway-instance-is-already-listening-mean)
  - [How do I run YoyoClaw in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-yoyoclaw-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart YoyoClaw?](#i-closed-my-terminal-on-windows-how-do-i-restart-yoyoclaw)
  ...
  - [ELI5: `yoyoclaw gateway restart` vs `yoyoclaw gateway`](#eli5-yoyoclaw-gateway-restart-vs-yoyoclaw-gateway)
  - [What's the fastest way to get more details when something fails?](#whats-the-fastest-way-to-get-more-details-when-something-fails)
- [Media and attachments](#media-and-attachments)
  - [My skill generated an image/PDF, but nothing was sent](#my-skill-generated-an-imagepdf-but-nothing-was-sent)
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose YoyoClaw to inbound DMs?](#is-it-safe-to-expose-yoyoclaw-to-inbound-dms)
...
5. **Tail the latest log**
   ...
   ```bash
   tail -f "$(ls -t /tmp/daverjorge46/yoyoclaw-*.log | head -1)"
   ```
...
7. **Gateway snapshot**
   ...
   ```bash
   yoyoclaw health --json
   yoyoclaw health --verbose   # shows the target URL + config path on errors
   ```
...
This installs YoyoClaw **from a git checkout**, so the agent can read the code + docs and
...
[https://github.com/daverjorge46/yoyoclaw/issues](https://github.com/daverjorge46/yoyoclaw/issues)
[https://github.com/daverjorge46/yoyoclaw/pulls](https://github.com/daverjorge46/yoyoclaw/pulls)

Start with these commands (share outputs when asking for help):

```bash
yoyoclaw status
yoyoclaw models status
yoyoclaw doctor
```

What they do:

- `yoyoclaw status`: quick snapshot of gateway/agent health + basic config.
- `yoyoclaw models status`: checks provider auth + model availability.
- `yoyoclaw doctor`: validates and repairs common config/state issues.

Other useful CLI checks: `yoyoclaw status --all`, `yoyoclaw logs --follow`,
`yoyoclaw gateway status`, `yoyoclaw health --verbose`.

Quick debug loop: [First 60 seconds if something's broken](#first-60-seconds-if-somethings-broken).
Install docs: [Install](/install), [Installer flags](/install/installer), [Updating](/install/updating).

### What's the recommended way to install and set up YoyoClaw

The repo recommends running from source and using the onboarding wizard:

```bash
curl -fsSL https://openclaw.ai/install.sh | bash
yoyoclaw onboard --install-daemon
```
...
If you don't have a global install yet, run it via `pnpm yoyoclaw onboard`.
...
- Retrieve it from the gateway host: `yoyoclaw config get gateway.auth.token` (or generate one: `yoyoclaw doctor --generate-gateway-token`).

**Not on localhost:**

- **Tailscale Serve** (recommended): keep bind loopback, run `yoyoclaw gateway --tailscale serve`, open `https://<magicdns>/`. If `gateway.auth.allowTailscale` is `true`, identity headers satisfy auth (no token).
- **Tailnet bind**: run `yoyoclaw gateway --bind tailnet --token "<token>"`, open `http://<tailscale-ip>:18789/`, paste token in dashboard settings.
...
1. Install YoyoClaw on the new machine.
2. Copy `$OPENCLAW_STATE_DIR` (default: `~/.yoyoclaw`) from the old machine.
3. Copy your workspace (default: `~/.yoyoclaw/workspace`).
4. Run `yoyoclaw doctor` and restart the Gateway service.
...
under `~/.yoyoclaw/` (for example `~/.yoyoclaw/agents/<agentId>/sessions/`).

Related: [Migrating](/install/migrating), [Where things live on disk](/help/faq#where-does-yoyoclaw-store-its-data),
...
[https://github.com/daverjorge46/yoyoclaw/blob/main/CHANGELOG.md](https://github.com/daverjorge46/yoyoclaw/blob/main/CHANGELOG.md)
...
[https://github.com/daverjorge46/yoyoclaw/tree/main/docs](https://github.com/daverjorge46/yoyoclaw/tree/main/docs)
...
### Windows install says git not found or yoyoclaw not recognized
...
**2) yoyoclaw is not recognized after install**
...
### How do I install YoyoClaw on Linux
...
### How do I install YoyoClaw on a VPS
...
### Can I ask YoyoClaw to update itself
...
```bash
yoyoclaw update
yoyoclaw update status
yoyoclaw update --channel stable|beta|dev
yoyoclaw update --tag <dist-tag|version>
yoyoclaw update --no-restart
```

If you must automate from an agent:

```bash
yoyoclaw update --yes --no-restart
yoyoclaw gateway restart
```
...
`yoyoclaw onboard` is the recommended setup path. In **local mode** it walks you through:
...
No. You can run YoyoClaw with **API keys** (Anthropic/OpenAI/others) or with
...
Copy the token it prints, then choose **Anthropic token (paste setup-token)** in the wizard. If you want to run it on the gateway host, use `yoyoclaw models auth setup-token --provider anthropic`. If you ran `claude setup-token` elsewhere, paste it on the gateway host with `yoyoclaw models auth paste-token --provider anthropic`. See [Anthropic](/providers/anthropic).

### Do you support Claude subscription auth (Claude Pro or Max)

Yes - via **setup-token**. YoyoClaw no longer reuses Claude Code CLI OAuth tokens; use a setup-token or an Anthropic API key. Generate the token anywhere and paste it on the gateway host. See [Anthropic](/providers/anthropic) and [OAuth](/concepts/oauth).
...
Tip: set a **fallback model** so YoyoClaw can keep replying while a provider is rate-limited.
...
YoyoClaw supports **OpenAI Code (Codex)** via OAuth (ChatGPT sign-in). The wizard can run the OAuth flow and will set the default model to `openai-codex/gpt-5.3-codex` when appropriate. See [Model providers](/concepts/model-providers) and [Wizard](/start/wizard).

### Do you support OpenAI subscription auth Codex OAuth

Yes. YoyoClaw fully supports **OpenAI Code (Codex) subscription OAuth**. The onboarding wizard
...
Gemini CLI uses a **plugin auth flow**, not a client id or secret in `yoyoclaw.json`.

Steps:

1. Enable the plugin: `yoyoclaw plugins enable google-gemini-cli-auth`
2. Login: `yoyoclaw models auth login --provider google-gemini-cli --set-default`

This stores OAuth tokens in auth profiles on the gateway host. Details: [Model providers](/concepts/model-providers).

### Is a local model OK for casual chats

Usually no. YoyoClaw needs large context + strong safety; small cards truncate and leak. If you must, run the **largest** MiniMax M2.1 build you can locally (LM Studio) and see [/gateway/local-models](/gateway/local-models). Smaller/quantized models increase prompt-injection risk - see [Security](/gateway/security).
...
No. YoyoClaw runs on macOS or Linux (Windows via WSL2). A Mac mini is optional - some people
...
### If I buy a Mac mini to run YoyoClaw can I connect it to my MacBook Pro
...
- Use `yoyoclaw nodes status` / `yoyoclaw nodes list` to see it.
...
The onboarding wizard accepts `@username` input and resolves it to a numeric ID, but YoyoClaw authorization uses numeric IDs only.

Safer (no third-party bot):

- DM your bot, then run `yoyoclaw logs --follow` and read `from.id`.
...
### Can multiple people use one WhatsApp number with different YoyoClaw instances
...
If you run YoyoClaw via systemd, ensure the service PATH includes `/home/linuxbrew/.linuxbrew/bin` (or your brew prefix) so `brew`-installed tools resolve in non-login shells.
...
This **does not delete your data** - it only changes the YoyoClaw code install. Your state
(`~/.yoyoclaw`) and workspace (`~/.yoyoclaw/workspace`) stay untouched.
...
**YoyoClaw-specific note:** WhatsApp/Telegram/Slack/Mattermost (plugin)/Discord all work fine from a VPS. The only real trade-off is **headless browser** vs a visible window. See [Browser](/tools/browser).

**Recommended default:** VPS if you had gateway disconnects before. Local is great when you're actively using the Mac and want local file access or UI automation with a visible browser.

### How important is it to run YoyoClaw on a dedicated machine
...
YoyoClaw is lightweight. For a basic Gateway + one chat channel:
...
### Can I run YoyoClaw in a VM and what are the requirements
...
### What is YoyoClaw in one paragraph

YoyoClaw is a personal AI assistant you run on your own devices. It replies on the messaging surfaces you already use (WhatsApp, Telegram, Slack, Mattermost (plugin), Discord, Google Chat, Signal, iMessage, WebChat) and can also do voice + a live Canvas on supported platforms. The **Gateway** is the always-on control plane; the assistant is the product.

### What's the value proposition

YoyoClaw is not "just a Claude wrapper." It's a **local-first control plane** that lets you run a
...
### What are the top five everyday use cases for YoyoClaw
...
### Can YoyoClaw help with lead gen outreach ads and blogs for a SaaS
...
YoyoClaw draft and you approve.

Docs: [Security](/gateway/security).

### What are the advantages vs Claude Code for web development

YoyoClaw is a **personal assistant** and coordination layer, not an IDE replacement. Use
Claude Code or Codex for the fastest direct coding loop inside a repo. Use YoyoClaw when you
...
Use managed overrides instead of editing the repo copy. Put your changes in `~/.yoyoclaw/skills/<name>/SKILL.md` (or add a folder via `skills.load.extraDirs` in `~/.daverjorge46/yoyoclaw.json`). Precedence is `<workspace>/skills` > `~/.yoyoclaw/skills` > bundled, so managed overrides win without touching git. Only upstream-worthy edits should live in the repo and go out as PRs.

### Can I load skills from a custom folder

Yes. Add extra directories via `skills.load.extraDirs` in `~/.daverjorge46/yoyoclaw.json` (lowest precedence). Default precedence remains: `<workspace>/skills` → `~/.yoyoclaw/skills` → bundled → `skills.load.extraDirs`. `clawhub` installs into `./skills` by default, which YoyoClaw treats as `<workspace>/skills`.
...
```bash
yoyoclaw cron run <jobId> --force
yoyoclaw cron runs --id <jobId> --limit 50
```
...
### Can YoyoClaw run tasks on a schedule or continuously in the background
...
Not directly. macOS skills are gated by `metadata.yoyoclaw.os` plus required binaries, and skills only appear in the system prompt when they are eligible on the **Gateway host**. On Linux, `darwin`-only skills (like `apple-notes`, `apple-reminders`, `things-mac`) will not load unless you override the gating.

You have three supported patterns:

**Option A - run the Gateway on a Mac (simplest).**
Run the Gateway where the macOS binaries exist, then connect from Linux in [remote mode](#how-do-i-run-yoyoclaw-in-remote-mode-client-connects-to-a-gateway-elsewhere) or over Tailscale. The skills load normally because the Gateway host is macOS.

**Option B - use a macOS node (no SSH).**
Run the Gateway on Linux, pair a macOS node (menubar app), and set **Node Run Commands** to "Always Ask" or "Always Allow" on the Mac. YoyoClaw can treat macOS-only skills as eligible when the required binaries exist on the node. The agent runs those skills via the `nodes` tool. If you choose "Always Ask", approving "Always Allow" in the prompt adds that command to the allowlist.
...
3. Override the skill metadata (workspace or `~/.yoyoclaw/skills`) to allow Linux:

   ```markdown
   ---
   name: apple-notes
   description: Manage Apple Notes via the memo CLI on macOS.
   metadata: { "yoyoclaw": { "os": ["darwin", "linux"], "requires": { "bins": ["memo"] } } }
   ---
   ```
...
ClawHub installs into `./skills` under your current directory (or falls back to your configured YoyoClaw workspace); YoyoClaw treats that as `<workspace>/skills` on the next session. For shared skills across agents, place them in `~/.yoyoclaw/skills/<name>/SKILL.md`. Some skills expect binaries installed via Homebrew; on Linux that means Linuxbrew (see the Homebrew Linux FAQ entry above). See [Skills](/tools/skills) and [ClawHub](/tools/clawhub).
...
```bash
yoyoclaw browser extension install
yoyoclaw browser extension path
```
...
YoyoClaw memory is just Markdown files in the agent workspace:

- Daily notes in `memory/YYYY-MM-DD.md`
- Curated long-term notes in `MEMORY.md` (main/private sessions only)

YoyoClaw also runs a **silent pre-compaction memory flush** to remind the model
...
If you don't set a provider explicitly, YoyoClaw auto-selects a provider when it
can resolve an API key (auth profiles, `models.providers.*.apiKey`, or env vars).
It prefers OpenAI if an OpenAI key resolves, otherwise Gemini if a Gemini key
resolves. If neither key is available, memory search stays disabled until you
configure it. If you have a local model path configured and present, YoyoClaw
prefers `local`.
...
### Is all data used with YoyoClaw saved locally

No - **YoyoClaw's state is local**, but **external services still see what you send them**.

- **Local by default:** sessions, memory files, config, and workspace live on the Gateway host
  (`~/.yoyoclaw` + your workspace directory).
...
### Where does YoyoClaw store its data

Everything lives under `$OPENCLAW_STATE_DIR` (default: `~/.yoyoclaw`):

| Path                                                            | Purpose                                                      |
| --------------------------------------------------------------- | ------------------------------------------------------------ |
| `$OPENCLAW_STATE_DIR/yoyoclaw.json`                             | Main config (JSON5)                                          |
...
Legacy single-agent path: `~/.yoyoclaw/agent/*` (migrated by `yoyoclaw doctor`).

Your **workspace** (AGENTS.md, memory files, skills, etc.) is separate and configured via `agents.defaults.workspace` (default: `~/.yoyoclaw/workspace`).

### Where should AGENTSmd SOULmd USERmd MEMORYmd live

These files live in the **agent workspace**, not `~/.yoyoclaw`.

- **Workspace (per agent)**: `AGENTS.md`, `SOUL.md`, `IDENTITY.md`, `USER.md`,
  `MEMORY.md` (or `memory.md`), `memory/YYYY-MM-DD.md`, optional `HEARTBEAT.md`.
- **State dir (`~/.yoyoclaw`)**: config, credentials, auth profiles, sessions, logs,
  and shared skills (`~/.yoyoclaw/skills`).

Default workspace is `~/.yoyoclaw/workspace`, configurable via:

```json5
{
  agents: { defaults: { workspace: "~/.yoyoclaw/workspace" } },
}
```
...
Do **not** commit anything under `~/.yoyoclaw` (credentials, sessions, tokens).
If you need a full restore, back up both the workspace and the state directory
separately (see the migration question above).

Docs: [Agent workspace](/concepts/agent-workspace).

### How do I completely uninstall YoyoClaw
...
`workspace` to the repo root. The YoyoClaw repo is just source code; keep the
...
YoyoClaw reads an optional **JSON5** config from `$OPENCLAW_CONFIG_PATH` (default: `~/.daverjorge46/yoyoclaw.json`):

```
$OPENCLAW_CONFIG_PATH
```

If the file is missing, it uses safe-ish defaults (including a default workspace of `~/.yoyoclaw/workspace`).
...
If you **really** want open loopback, remove `gateway.auth` from your config. Doctor can generate a token for you any time: `yoyoclaw doctor --generate-gateway-token`.
...
key. **Recommended:** run `yoyoclaw configure --section web` to store it in
...
- Daemons read env vars from `~/.yoyoclaw/.env` (or the service environment).
...
### Can the YoyoClaw browser run headless
...
5. Approve the node on the Gateway:
   ...
   ```bash
   yoyoclaw nodes pending
   yoyoclaw nodes approve <requestId>
   ```
...
- Gateway is running: `yoyoclaw gateway status`
- Gateway health: `yoyoclaw status`
- Channel health: `yoyoclaw channels status`
...
### Can two YoyoClaw instances talk to each other local VPS
...
`yoyoclaw agent --message ... --deliver`, targeting a chat where the other bot
...
```bash
yoyoclaw agent --message "Hello from local bot" --deliver --channel telegram --reply-to <chat-id>
```
...
- Restore from backup (git or a copied `~/.daverjorge46/yoyoclaw.json`).
- If you have no backup, re-run `yoyoclaw doctor` and reconfigure channels/models.
- If this was unexpected, file a bug and include your last known config or any backup.
- A local coding agent can often reconstruct a working config from logs or history.

Avoid it:

- Use `yoyoclaw config set` for small changes.
- Use `yoyoclaw configure` for interactive edits.
...
```bash
yoyoclaw gateway --tailscale serve
```
...
### How does YoyoClaw load environment variables

YoyoClaw reads env vars from the parent process (shell, launchd/systemd, CI, etc.) and additionally loads:

- `.env` from the current working directory
- a global fallback `.env` from `~/.yoyoclaw/.env` (aka `$OPENCLAW_STATE_DIR/.env`)
...
1. Put the missing keys in `~/.yoyoclaw/.env` so they're picked up even when the service doesn't inherit your shell env.
...
`yoyoclaw models status` reports whether **shell env import** is enabled. "Shell env: off"
does **not** mean your env vars are missing - it just means YoyoClaw won't load
your login shell automatically.

If the Gateway runs as a service (launchd/systemd), it won't inherit your shell
environment. Fix by doing one of these:

1. Put the token in `~/.yoyoclaw/.env`:
...
### Is there a way to make a team of YoyoClaw instances one CEO and many agents
...
### How do I completely reset YoyoClaw but keep it installed
...
```bash
yoyoclaw reset --scope full --yes --non-interactive
```
...
- If you used profiles (`--profile` / `OPENCLAW_PROFILE`), reset each state dir (defaults are `~/.yoyoclaw-<profile>`).
- Dev reset: `yoyoclaw gateway --dev --reset` (dev-only; wipes dev config + credentials + sessions + workspace).
...
headers like `# Heading`), YoyoClaw skips the heartbeat run to save API calls.
...
No. YoyoClaw runs on **your own account**, so if you're in the group, YoyoClaw can see it.
...
```bash
yoyoclaw directory groups list --channel whatsapp
```

Docs: [WhatsApp](/channels/whatsapp), [Directory](/cli/directory), [Logs](/cli/logs).

### Why doesnt YoyoClaw reply in a group
...
- **Disk growth:** sessions + transcripts live under `~/.yoyoclaw/agents/<agentId>/sessions/`.
...
- Use `yoyoclaw doctor` to spot stray workspaces and profile mismatches.
...
YoyoClaw's default model is whatever you set as:

```
agents.defaults.model.primary
```

Models are referenced as `provider/model` (example: `anthropic/claude-opus-4-6`). If you omit the provider, YoyoClaw currently assumes `anthropic` as a temporary deprecation fallback - but you should still **explicitly** set `provider/model`.
...
- `yoyoclaw models set ...` (updates just model config)
- `yoyoclaw configure --section model` (interactive)
- edit `agents.defaults.model` in `~/.daverjorge46/yoyoclaw.json`

Avoid `config.apply` with a partial object unless you intend to replace the whole config.
If you did overwrite config, restore from backup or re-run `yoyoclaw doctor` to repair.

Docs: [Models](/concepts/models), [Configure](/cli/configure), [Config](/cli/config), [Doctor](/gateway/doctor).

### What do YoyoClaw, Flawd, and Krill use for models

- **YoyoClaw + Flawd:** Anthropic Opus (`anthropic/claude-opus-4-6`) - see [Anthropic](/providers/anthropic).
...
Yes. YoyoClaw ships a few default shorthands (only applied when the model exists in `agents.defaults.models`):
...
```
~/.yoyoclaw/agents/<agentId>/agent/auth-profiles.json
```

Fix options:

- Run `yoyoclaw agents add <id>` and configure auth during the wizard.
...
Cooldowns apply to failing profiles (exponential backoff), so YoyoClaw can keep responding even when a provider is rate-limited or temporarily failing.
...
- **Confirm where auth profiles live** (new vs legacy paths)
  - Current: `~/.yoyoclaw/agents/<agentId>/agent/auth-profiles.json`
  - Legacy: `~/.yoyoclaw/agent/*` (migrated by `yoyoclaw doctor`)
- **Confirm your env var is loaded by the Gateway**
  - If you set `ANTHROPIC_API_KEY` in your shell but run the Gateway via systemd/launchd, it may not inherit it. Put it in `~/.yoyoclaw/.env` or enable `env.shellEnv`.
- **Make sure you're editing the correct agent**
  - Multi-agent setups mean there can be multiple `auth-profiles.json` files.
- **Sanity-check model/auth status**
  - Use `yoyoclaw models status` to see configured models and whether providers are authenticated.
...
- **Use a setup-token**
  - Run `claude setup-token`, then paste it with `yoyoclaw models auth setup-token --provider anthropic`.
  - If the token was created on another machine, use `yoyoclaw models auth paste-token --provider anthropic`.
- **If you want to use an API key instead**
  - Put `ANTHROPIC_API_KEY` in `~/.yoyoclaw/.env` on the **gateway host**.
  - Clear any pinned order that forces a missing profile:

    ```bash
    yoyoclaw models auth order clear --provider anthropic
    ```
...
If your model config includes Google Gemini as a fallback (or you switched to a Gemini shorthand), YoyoClaw will try it during model fallback. If you haven't configured Google credentials, you'll see `No API key found for provider "google"`.
...
Fix: YoyoClaw now strips unsigned thinking blocks for Google Antigravity Claude. If it still appears, start a **new session** or set `/thinking off` for that agent.
...
YoyoClaw uses provider-prefixed IDs like:
...
YoyoClaw may temporarily skip a profile if it's in a short **cooldown** (rate limits/timeouts/auth failures) or a longer **disabled** state (billing/insufficient credits). To inspect this, run `yoyoclaw models status --json` and check `auth.unusableProfiles`. Tuning: `auth.cooldowns.billingBackoffHours*`.

You can also set a **per-agent** order override (stored in that agent's `auth-profiles.json`) via the CLI:

```bash
# Defaults to the configured default agent (omit --agent)
yoyoclaw models auth order get --provider anthropic

# Lock rotation to a single profile (only try this one)
yoyoclaw models auth order set --provider anthropic anthropic:default

# Or set an explicit order (fallback within provider)
yoyoclaw models auth order set --provider anthropic anthropic:work anthropic:default
...
```bash
yoyoclaw models auth order set --provider anthropic --agent main anthropic:default
```

### OAuth vs API key whats the difference

YoyoClaw supports both:
...
### Why does yoyoclaw gateway status say Runtime running but RPC probe failed

Because "running" is the **supervisor's** view (launchd/systemd/schtasks). The RPC probe is the CLI actually connecting to the gateway WebSocket and calling `status`.

Use `yoyoclaw gateway status` and trust these lines:

- `Probe target:` (the URL the probe actually used)
- `Listening:` (what's actually bound on the port)
- `Last gateway error:` (common root cause when the process is alive but the port isn't listening)

### Why does yoyoclaw gateway status show Config cli and Config service different
...
```bash
yoyoclaw gateway install --force
```
...
YoyoClaw enforces a runtime lock by binding the WebSocket listener immediately on startup (default `ws://127.0.0.1:18789`). If the bind fails with `EADDRINUSE`, it throws `GatewayLockError` indicating another instance is already listening.

Fix: stop the other instance, free the port, or run with `yoyoclaw gateway --port <port>`.

### How do I run YoyoClaw in remote mode client connects to a Gateway elsewhere
...
- `yoyoclaw gateway` only starts when `gateway.mode` is `local` (or you pass the override flag).
...
- The Control UI stores the token in browser localStorage key `yoyoclaw.control.settings.v1`.

Fix:

- Fastest: `yoyoclaw dashboard` (prints + copies the dashboard URL, tries to open; shows SSH hint if headless).
- If you don't have a token yet: `yoyoclaw doctor --generate-gateway-token`.
- If remote, tunnel first: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/`.
- Set `gateway.auth.token` (or `OPENCLAW_GATEWAY_TOKEN`) on the gateway host.
- In the Control UI settings, paste the same token.
- Still stuck? Run `yoyoclaw status --all` and follow [Troubleshooting](/gateway/troubleshooting). See [Dashboard](/web/dashboard) for auth details.
...
- Use `yoyoclaw --profile <name> …` per instance (auto-creates `~/.yoyoclaw-<name>`).
- Set a unique `gateway.port` in each profile config (or pass `--port` for manual runs).
- Install a per-profile service: `yoyoclaw --profile <name> gateway install`.

Profiles also suffix service names (`bot.molt.<profile>`; legacy `com.yoyoclaw.*`, `yoyoclaw-gateway-<profile>.service`, `YoyoClaw Gateway (<profile>)`).
...
```
yoyoclaw tui --url ws://<host>:18789 --token <token>
```
...
```
/tmp/daverjorge46/yoyoclaw-YYYY-MM-DD.log
```
...
- macOS: `$OPENCLAW_STATE_DIR/logs/gateway.log` and `gateway.err.log` (default: `~/.yoyoclaw/logs/...`; profiles use `~/.yoyoclaw-<profile>/logs/...`)
- Linux: `journalctl --user -u yoyoclaw-gateway[-<profile>].service -n 200 --no-pager`
- Windows: `schtasks /Query /TN "YoyoClaw Gateway (<profile>)" /V /FO LIST`
...
If you run the gateway manually, `yoyoclaw gateway --force` can reclaim the port. See [Gateway](/gateway).

### I closed my terminal on Windows how do I restart YoyoClaw
...
1. Is the Gateway running? `yoyoclaw gateway status`
2. Is the Gateway healthy? `yoyoclaw status`
3. Does the UI have the right token? `yoyoclaw dashboard`
...
```bash
yoyoclaw channels status
yoyoclaw channels logs --channel telegram
```
...
### ELI5 yoyoclaw gateway restart vs yoyoclaw gateway

- `yoyoclaw gateway restart`: restarts the **background service** (launchd/systemd).
- `yoyoclaw gateway`: runs the gateway **in the foreground** for this terminal session.

If you installed the service, use the gateway commands. Use `yoyoclaw gateway` when
...
Outbound attachments from the agent must include a `MEDIA:<path-or-url>` line (on its own line). See [YoyoClaw assistant setup](/start/yoyoclaw) and [Agent send](/tools/agent-send).

CLI sending:

```bash
yoyoclaw message send --target +15555550123 --message "Here you go" --media /path/to/file.png
```
...
### Is it safe to expose YoyoClaw to inbound DMs

Treat inbound DMs as untrusted input. Defaults are designed to reduce risk:

- Default behavior on DM-capable channels is **pairing**:
  - Unknown senders receive a pairing code; the bot does not process their message.
  - Approve with: `yoyoclaw pairing approve <channel> <code>`
  - Pending requests are capped at **3 per channel**; check `yoyoclaw pairing list <channel>` if a code didn't arrive.
- Opening DMs publicly requires explicit opt-in (`dmPolicy: "open"` and allowlist `"*"`).

Run `yoyoclaw doctor` to surface risky DM policies.
...
```bash
yoyoclaw pairing list telegram
```
...
No. Default WhatsApp DM policy is **pairing**. Unknown senders only get a pairing code and their message is **not processed**. YoyoClaw only replies to chats it receives or to explicit sends you trigger.

Approve pairing with:

```bash
yoyoclaw pairing approve whatsapp <code>
```

List pending requests:

```bash
yoyoclaw pairing list whatsapp
```
...
YoyoClaw blocks **cross-provider** messaging by default. If a tool call is bound
