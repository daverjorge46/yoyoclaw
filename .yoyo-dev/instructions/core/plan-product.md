---
description: Product Planning Rules for Yoyo Dev
globs:
alwaysApply: false
version: 4.0
encoding: UTF-8
...
<fallback_sequence> 1. @.yoyo-dev/standards/tech-stack.md 2. @.claude/CLAUDE.md 3. Cursor User Rules
</fallback_sequence>
</data_sources>
...
Use the file-creator subagent to create the file: .yoyo-dev/product/mission.md and use the following template:
...
Use the file-creator subagent to create the file: .yoyo-dev/product/tech-stack.md and use the following template:
...
<then_check> 1. @.yoyo-dev/standards/tech-stack.md 2. @.claude/CLAUDE.md 3. Cursor User Rules
</then_check>
...
Use the file-creator subagent to create the file: .yoyo-dev/product/mission-lite.md for the purpose of establishing a condensed mission for efficient AI context usage.
...
Use the file-creator subagent to create the following file: .yoyo-dev/product/roadmap.md using the following template:
