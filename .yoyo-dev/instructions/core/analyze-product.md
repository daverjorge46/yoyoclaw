---
description: Analyze Current Product & Install Yoyo Dev
globs:
alwaysApply: false
version: 1.0
encoding: UTF-8
...
# Analyze Current Product & Install Yoyo Dev

## Overview

Install Yoyo Dev into an existing codebase, analyze current product state and progress. Builds on plan-product.md
...
To properly set up Yoyo Dev, I need to understand:
...
Execute our standard flow for installing Yoyo Dev in existing products
...
I'm installing Yoyo Dev into an existing product. Here's what I've gathered:
...
<instructions>
  ...
  ALLOW: plan-product.md to create .yoyo-dev/product/ structure
</instructions>
...
Verify installation completeness and provide clear next steps for the user to start using Yoyo Dev with their existing codebase.

<verification_checklist>

- [ ] .yoyo-dev/product/ directory created
...
## ✅ Yoyo Dev Successfully Installed

I've analyzed your [PRODUCT_TYPE] codebase and set up Yoyo Dev with documentation that reflects your actual implementation.
...
- ✓ Product documentation in `.yoyo-dev/product/`
...
Your codebase is now Yoyo Dev-enabled! 🚀
</summary_template>
