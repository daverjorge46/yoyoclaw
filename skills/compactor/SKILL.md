...
When the user asks to "compact" or "summarize" a session log, follow these steps:

1.  **Read** the target file (or input text).
2.  **Process** the content using your own LLM reasoning.
3.  **Output** the summary directly in the chat or write it to a file as requested.
