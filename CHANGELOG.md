...
- Slack: add queue position indicators showing users their place in the message queue via emoji reactions (1️⃣, 2️⃣, 3️⃣, etc.), with automatic updates as the queue drains and a processing indicator (⏳) when AI response begins.
