/**
 * Device Identity Management for Clawdbrain Web UI.
 *
 * Handles Ed25519 keypair generation and storage for device authentication
 * with the Gateway Protocol v3.
 */
...
const STORAGE_KEY = "clawdbrain-web-device-identity-v1";
