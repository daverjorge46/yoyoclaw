...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant, size, asChild = false, ...props }, ref) => {
    // For prototype, avoiding dependency on @radix-ui/react-slot just for asChild.
    // If installed, we use Slot. If not, simpler fallback or just button.
    // Given we didn't install @radix-ui/react-slot in package.json, I'll fallback to button.
    const Comp = "button"
    return (
      <Comp
