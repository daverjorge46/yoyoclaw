...
- If you see a secret in a file during a review, **WARN** the user immediately.
...
- If agent compromise is suspected: kill gateway (`pkill -9 -f openclaw-gateway`), rotate all API keys and bot tokens, check `SOUL.md`/`AGENTS.md`/`TOOLS.md` for memory poisoning.
