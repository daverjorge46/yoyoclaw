...
export function renderCron(props: CronProps) {
  ...
  // biome-ignore lint: translation key fallback
  ...
  return html`
        ...
        <div class="form-grid" style="margin-top: 16px;">
          ...
          <label class="field">
            ...
            <input
              ...
              placeholder=${t("cron.defaultPlaceholder")}
            />
          </label>
    ...
    <section class="card" style="margin-top: 18px;">
      ...
      <div class="card-sub">${t("cron.runHistorySub", { jobName: selectedRunTitle })}</div>
      ${
    ...
    ${
      delivery
        ? html`<div class="cron-job-detail">
            <span class="cron-job-detail-label">${t("common.delivery")}</span>
  ...
  return html`
    <div class="cron-job-state">
      <div class="cron-job-state-row">
        <span class="cron-job-state-key">${t("common.status")}</span>
      ...
      <div class="cron-job-state-row">
        <span class="cron-job-state-key">${t("cron.lastRun")}</span>
