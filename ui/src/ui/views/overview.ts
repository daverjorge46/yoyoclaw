  ...
  const insecureContextHint = (() => {
    ...
    return html`
      <div class="muted" style="margin-top: 8px">
        ...
        <div style="margin-top: 6px">
          ${t("overview.insecureContextFix")}
          <span class="mono">${t("overview.insecureContextConfig")}</span> (token-only).
        </div>
        <div style="margin-top: 6px">
          <a
            class="session-link"
    ...
    <section class="grid grid-cols-2">
      <div class="card">
        ...
        <div class="form-grid" style="margin-top: 16px;">
          <label class="field">
            ...
            <input
              ...
              placeholder=${t("overview.wsPlaceholder")}
            />
          </label>
          <label class="field">
        ...
        <div class="row" style="margin-top: 14px;">
          ...
          <span class="muted">${t("overview.connectApply")}</span>
        </div>
      </div>
