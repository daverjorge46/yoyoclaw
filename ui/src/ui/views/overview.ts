      ...
      return html`
        <div class="muted" style="margin-top: 8px">
          ...
          <div style="margin-top: 6px">
            <span class="mono">yoyoclaw dashboard --no-open</span> → open the Control UI<br />
            <span class="mono">yoyoclaw doctor --generate-gateway-token</span> → set token
          </div>
          <div style="margin-top: 6px">
            <a
              class="session-link"
              ...
              : html`
                <label class="field">
                  ...
                  <input
                    ...
                    placeholder="YOYOCLAW_GATEWAY_TOKEN"
                  />
                </label>
                <label class="field">
