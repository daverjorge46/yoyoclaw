...
const TOOL_SECTIONS = [
  {
    id: "fs",
    label: t("agents.catFiles"),
    tools: [
      { id: "read", label: "read", description: t("agents.descRead") },
      { id: "write", label: "write", description: t("agents.descWrite") },
      { id: "edit", label: "edit", description: t("agents.descEdit") },
      { id: "apply_patch", label: "apply_patch", description: t("agents.descApplyPatch") },
    ],
  },
  {
    id: "runtime",
    label: t("agents.catRuntime"),
    tools: [
      { id: "exec", label: "exec", description: t("agents.descExec") },
      { id: "process", label: "process", description: t("agents.descProcess") },
    ],
  },
  {
    id: "web",
    label: t("agents.catWeb"),
    tools: [
      { id: "web_search", label: "web_search", description: t("agents.descWebSearch") },
      { id: "web_fetch", label: "web_fetch", description: t("agents.descWebFetch") },
    ],
  },
  {
    id: "memory",
    label: t("agents.catMemory"),
    tools: [
      { id: "memory_search", label: "memory_search", description: t("agents.descMemorySearch") },
      { id: "memory_get", label: "memory_get", description: t("agents.descMemoryGet") },
    ],
  },
  {
    id: "sessions",
  ...
  {
    id: "ui",
    label: t("agents.catUI"),
    tools: [
      { id: "browser", label: "browser", description: t("agents.descBrowser") },
      { id: "canvas", label: "canvas", description: t("agents.descCanvas") },
    ],
  },
  {
    id: "messaging",
    label: t("agents.catMessaging"),
    tools: [{ id: "message", label: "message", description: t("agents.descMessage") }],
  },
  {
    id: "automation",
    label: t("agents.catAutomation"),
    tools: [
      { id: "cron", label: "cron", description: t("agents.descCron") },
      { id: "gateway", label: "gateway", description: t("agents.descGateway") },
    ],
  },
  {
    id: "nodes",
    label: t("agents.catNodes"),
    tools: [{ id: "nodes", label: "nodes", description: t("agents.descNodes") }],
  },
  {
    id: "agents",
    label: t("agents.catAgents"),
    tools: [{ id: "agents_list", label: "agents_list", description: t("agents.descAgentsList") }],
  },
  {
    id: "media",
    label: t("agents.catMedia"),
...
function buildModelOptions(configForm: Record<string, unknown> | null, current?: string | null) {
  ...
  if (current && !hasCurrent) {
    options.unshift({ value: current, label: `${t("agents.current")} (${current})` });
  }
  if (options.length === 0) {
    return html`
    ...
    <section class="card">
      ...
      <div class="agents-overview-grid" style="margin-top: 16px;">
        ...
        <div class="agent-kv">
          ...
          <div>${skillFilter ? t("agents.overview.selectedSkills", { count: String(skillCount) }) : t("agents.overview.allSkills")}</div>
        </div>
      </div>
...
function renderAgentChannels(params: {
  ...
  return html`
    <section class="grid grid-cols-2">
      ${renderAgentContextCard(context, t("agents.context.workspaceIdentity"))}
      <section class="card">
        <div class="row" style="justify-content: space-between;">
          <div>
      ...
      <section class="card">
        <div class="row" style="justify-content: space-between;">
          <div>
            ...
            <div class="card-sub">${t("agents.cron.schedulerSub")}</div>
          </div>
          <button class="btn btn--sm" ?disabled=${params.loading} @click=${params.onRefresh}>
            ${params.loading ? t("common.refreshing") : t("common.refresh")}
          </button>
...
function renderAgentFiles(params: {
  ...
  return html`
    <section class="card">
      ...
      ${list ? html`<div class="muted mono" style="margin-top: 8px;">${t("agents.files.workspace")}: ${list.workspace}</div>` : nothing}
      ${
                            ...
                            activeEntry.missing
                              ? html`
                                  <div class="callout info" style="margin-top: 10px">
                                    ${t("agents.files.fileMissingHint")}
                                  </div>
                                `
                              : nothing
                          }
  ...
  return html`
    ...
    >
      ...
      ${
        file.missing
          ? html`
              <span class="agent-pill warn">${t("agents.files.missing")}</span>
            `
          : nothing
      }
    </button>
  ...
  return html`
    <div class="list-item agent-skill-row">
      <div class="list-main">
        ...
        ${
          missing.length > 0
            ? html`<div class="muted" style="margin-top: 6px;">${t("agents.skills.missingLabel")}: ${missing.join(", ")}</div>`
            : nothing
        }
        ${
          reasons.length > 0
            ? html`<div class="muted" style="margin-top: 6px;">${t("agents.skills.reasonLabel")}: ${reasons.join(", ")}</div>`
            : nothing
        }
      </div>
      <div class="list-meta">
