...
export function registerOnboardCommand(program: Command) {
  program
    ...
    .option("--huawei-maas-api-key <key>", "Huawei Cloud MAAS API key")
        ...
        await onboardCommand(
          {
            ...
            huaweiMaasApiKey: opts.huaweiMaasApiKey as string | undefined,
            gatewayPort:
