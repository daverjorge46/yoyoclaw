const DEFAULT_TAGLINE = "The AI that actually does things.";
...
const TAGLINES: string[] = [
  ...
  "Automation with attitude: minimal fuss, maximal results.",
  ...
  "I'll streamline your workflow like a pro: messy inputs, clean outputs.",
  ...
  "The only bot in your contacts you actually want to hear from. ¯\\_(ツ)_/¯",
