...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.defaults.runtimeEngine": "Runtime Engine",
  "agents.defaults.runtimeEvalMode": "Runtime Eval Mode",
  "agents.defaults.runtimePlanRetries": "Runtime Plan Retries",
  "agents.list.*.runtimeEngine": "Runtime Engine",
  "agents.list.*.runtimeEvalMode": "Runtime Eval Mode",
  "agents.list.*.runtimePlanRetries": "Runtime Plan Retries",
  "agents.list[].runtimeEngine": "Runtime Engine",
  "agents.list[].runtimeEvalMode": "Runtime Eval Mode",
  "agents.list[].runtimePlanRetries": "Runtime Plan Retries",
