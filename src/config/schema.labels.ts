...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.defaults.heartbeat.model": "Heartbeat Model (legacy)",
  "agents.defaults.heartbeat.primary": "Heartbeat Primary Model",
  "agents.defaults.heartbeat.fallbacks": "Heartbeat Model Fallbacks",
  "agents.defaults.heartbeat.fallbackMode": "Heartbeat Fallback Mode",
