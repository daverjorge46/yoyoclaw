...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.defaults.envelopeInboundTime": "Inbound Meta Timestamp",
  "agents.defaults.envelopeInboundTimeSkipMs": "Inbound Meta Timestamp Skip (ms)",
  "agents.defaults.envelopeInboundTimeMaxGapMs": "Inbound Meta Timestamp Max Gap (ms)",
  "agents.defaults.envelopeInboundTimeDateMs": "Inbound Meta Timestamp Date Threshold (ms)",
