      ...
      .object({
        ...
        cooldowns: z
          .object({
            ...
            timeoutEscalationThreshold: z.number().int().min(1).optional(),
            timeoutEscalationMinutes: z.number().positive().optional(),
            timeoutEscalationMaxMinutes: z.number().positive().optional(),
          })
          .strict()
          .optional(),
      })
