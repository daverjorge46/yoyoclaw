...
const VoiceNotesTranscriptionSchema = z
  .object({
    enabled: z.boolean().optional(),
    provider: z.enum(["groq"]).optional(), // openai support planned
    model: z.string().optional(),
...
const VoiceNotesSchema = z
  .object({
    transcription: VoiceNotesTranscriptionSchema,
  })
  .optional();

const VideoUnderstandingSchema = z
  .object({
    enabled: z.boolean().optional(),
...
const VideoSchema = z
  .object({
    understanding: VideoUnderstandingSchema,
  })
  .optional();
