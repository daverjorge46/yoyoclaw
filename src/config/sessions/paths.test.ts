...
describe("resolveStorePath", () => {
  ...
  it("uses OPENCLAW_HOME for tilde expansion", () => {
    ...
    const resolved = resolveStorePath("~/.yoyoclaw/agents/{agentId}/sessions/sessions.json", {
      agentId: "research",
    });

    expect(resolved).toBe(
      path.resolve("/srv/openclaw-home/.yoyoclaw/agents/research/sessions/sessions.json"),
    );
  });
});
