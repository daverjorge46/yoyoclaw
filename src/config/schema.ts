...
const FIELD_LABELS: Record<string, string> = {
  ...
  "auth.cooldowns.timeoutEscalationThreshold": "Timeout Escalation Threshold",
  "auth.cooldowns.timeoutEscalationMinutes": "Timeout Escalation Cooldown (min)",
  "auth.cooldowns.timeoutEscalationMaxMinutes": "Timeout Escalation Cap (min)",
