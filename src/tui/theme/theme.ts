...
export const theme = {
  ...
  get userText() {
    const p = getPalette();
    return fg(p.userText);
  },
  get toolTitle() {
    const p = getPalette();
    return fg(p.toolTitle);
  },
  get toolOutput() {
    const p = getPalette();
    return fg(p.toolOutput);
  },
  get toolPendingBg() {
    const p = getPalette();
    return bg(p.toolPendingBg);
  },
  get toolSuccessBg() {
    const p = getPalette();
    return bg(p.toolSuccessBg);
  },
  get toolErrorBg() {
    const p = getPalette();
    return bg(p.toolErrorBg);
  },
  get border() {
    const p = getPalette();
    return fg(p.border);
...
export const markdownTheme: MarkdownTheme = {
  ...
  get link() {
    const p = getPalette();
    return (text: string) => fg(p.link)(text);
  },
  linkUrl: (text) => chalk.dim(text),
  get code() {
    const p = getPalette();
    return (text: string) => fg(p.code)(text);
  },
  get codeBlock() {
    const p = getPalette();
    return (text: string) => fg(p.code)(text);
  ...
  get codeBlockBorder() {
    const p = getPalette();
    return (text: string) => fg(p.codeBorder)(text);
  },
  get quote() {
    const p = getPalette();
    return (text: string) => fg(p.quote)(text);
  },
  get quoteBorder() {
    const p = getPalette();
    return (text: string) => fg(p.quoteBorder)(text);
  },
  get hr() {
    const p = getPalette();
    return (text: string) => fg(p.border)(text);
  },
  get listBullet() {
    const p = getPalette();
    return (text: string) => fg(p.accentSoft)(text);
  },
...
export const selectListTheme: SelectListTheme = {
  get selectedPrefix() {
    const p = getPalette();
    return (text: string) => fg(p.accent)(text);
  },
  get selectedText() {
    const p = getPalette();
    return (text: string) => chalk.bold(fg(p.accent)(text));
  ...
  get description() {
    const p = getPalette();
    return (text: string) => fg(p.dim)(text);
  },
  get scrollInfo() {
    const p = getPalette();
    return (text: string) => fg(p.dim)(text);
...
export const settingsListTheme: SettingsListTheme = {
  ...
  get description() {
    const p = getPalette();
    return (text: string) => fg(p.systemText)(text);
  },
  get cursor() {
    const p = getPalette();
    return fg(p.accent)("→ ");
...
export const searchableSelectListTheme: SearchableSelectListTheme = {
  ...
  get searchInput() {
    const p = getPalette();
    return (text: string) => fg(p.text)(text);
  },
  get matchHighlight() {
    const p = getPalette();
    return (text: string) => chalk.bold(fg(p.accent)(text));
