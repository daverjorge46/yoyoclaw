...
/**
 * Look up a sub-agent run by its child session key.
 * Returns the record if found, or undefined.
 */
export function findSubagentRunByChildKey(childSessionKey: string): SubagentRunRecord | undefined {
