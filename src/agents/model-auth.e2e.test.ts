...
describe("getApiKeyForModel", () => {
  ...
  it("accepts legacy Z_AI_API_KEY for zai", async () => {
    ...
    try {
      delete process.env.ZAI_API_KEY;
      process.env.Z_AI_API_KEY = "zai-test-key"; // pragma: allowlist secret
  ...
  it("resolves Synthetic API key from env", async () => {
    ...
    try {
      process.env.SYNTHETIC_API_KEY = "synthetic-test-key"; // pragma: allowlist secret
  ...
  it("resolves Vercel AI Gateway API key from env", async () => {
    ...
    try {
      process.env.AI_GATEWAY_API_KEY = "gateway-test-key"; // pragma: allowlist secret
  ...
  it("prefers Bedrock bearer token over access keys and profile", async () => {
    ...
    try {
      ...
      process.env.AWS_SECRET_ACCESS_KEY = "secret-key"; // pragma: allowlist secret
