...
export function buildSubagentSystemPrompt(params: {
  ...
  const lines = [
    ...
    "",
    "## Progress Reporting",
    "For long-running tasks (>2 minutes), use `subagent_progress` to send updates to the parent agent.",
    "Call it at major milestones — e.g. after completing a phase, not on every step.",
    "Example: `subagent_progress({ message: 'Built 6/12 workers', percent: 50 })`",
    "",
    "## Output Format",
