...
export const GATEWAY_WINDOWS_TASK_NAME = "YoYo-Claw Gateway";
...
export const NODE_WINDOWS_TASK_NAME = "YoYo-Claw Node";
...
export function resolveGatewayWindowsTaskName(profile?: string): string {
  ...
  return `YoYo-Claw Gateway (${normalized})`;
}
...
export function formatGatewayServiceDescription(params?: {
  ...
  if (parts.length === 0) {
    return "YoYo-Claw Gateway";
  }
  return `YoYo-Claw Gateway (${parts.join(", ")})`;
}
