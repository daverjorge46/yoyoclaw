...
homepage: https://docs.yoyoclaw.ai/automation/hooks#session-memory
metadata:
  {
    "openclaw":
      {
...
- Uses your workspace directory (`~/.yoyoclaw/workspace` by default)
...
```bash
yoyoclaw hooks disable session-memory
```
