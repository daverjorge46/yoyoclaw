...
export async function statusCommand(
  ...
  runtime.log(theme.heading("YoYoClaw status"));
  runtime.log("");
  ...
  runtime.log(theme.muted(`Full report: ${formatCliCommand("yoyoclaw security audit")}`));
  runtime.log(theme.muted(`Deep probe: ${formatCliCommand("yoyoclaw security audit --deep")}`));
  ...
  runtime.log("");
  runtime.log("FAQ: https://docs.yoyoclaw.ai/faq");
  runtime.log("Troubleshooting: https://docs.yoyoclaw.ai/troubleshooting");
  runtime.log("");
  ...
  runtime.log(`  Need to share?      ${formatCliCommand("yoyoclaw status --all")}`);
  runtime.log(`  Need to debug live? ${formatCliCommand("yoyoclaw logs --follow")}`);
  if (gatewayReachable) {
    runtime.log(`  Need to test channels? ${formatCliCommand("yoyoclaw status --deep")}`);
  } else {
    runtime.log(`  Fix reachability first: ${formatCliCommand("yoyoclaw gateway probe")}`);
  }
}
